...
const artistasSolistas = (objetoArtistas) => {
 return objetoArtistas.filter(elemento => elemento.solista)
...
const artistasPorEdad = (objetoArtistas) => {
    return objetoArtistas.filter(elemento => elemento.edad == 21)
}

console.log(artistasPorEdad(artistas))

//Por Instrumento

const cantidadDeArtitasPorInstrumento = (objetoArtistas) => {
   let acumulador = {}
    for (const artista of objetoArtistas){
        if(artista.instrumento == 'voz'){

            acumulador[artista.instrumento]=1
            voz+=+1
        }
...
console.log(cantidadDeArtitasPorInstrumento(artistas))